...
class _CabBookingFormState extends State<CabBookingForm> {
  ...
  late FocusNode commissionFocusNode;
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              margin: const EdgeInsets.only(
                  top: 40.0, left: 30, right: 30, bottom: 30),
              decoration: BoxDecoration(
                color: kPrimaryColor,
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.verified, color: kPrimaryColor),
                      ),
                    ),
                  ),
                  Padding(
