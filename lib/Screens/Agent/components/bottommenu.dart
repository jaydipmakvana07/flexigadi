...
import 'package:flexigadi/Screens/Agent/screen/Profile/screen/profilescreen.dart';
import 'package:flexigadi/Screens/Agent/screen/Requirement/screen/requirementscreen.dart';
import 'package:flexigadi/Screens/Calculator/screen/calculator_agent.dart';
import '../../Agent/screen/Available/screen/availablescreen.dart';
        ...
        setState(() {
          ...
          switch (index) {
            ...
            case 1:
              ...
              Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (context) => RequirementAgentScreen(),
              ));
              break;
            case 2:
              // Navigate to Home
            ...
            case 3:
              ...
              Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (context) => Calculatoragent(),
              ));
              break;
            case 4:
              // Navigate to Profile
              Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (context) => ProfileAgentScreen(),
              ));
