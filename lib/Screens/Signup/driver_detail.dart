import 'package:flexigadi/Screens/Signup/signup_screen_driver.dart';
...
class DriverDetailsForm extends StatefulWidget {
  const DriverDetailsForm({Key? key}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                MultiSelectDialogField(
                  dialogHeight: 200,
                  items: _cars
                      .map((car) => MultiSelectItem<String>(car, car))
                      .toList(),
                  title: Padding(
                    padding:
                  ...
                  buttonText: Text('Select Cars',
                      style: TextStyle(color: lightBlack)), // Button text color
                  buttonIcon: Icon(Icons.arrow_drop_down, color: lightBlack),
                  // Button icon color
                  onConfirm: (values) {
                    setState(() {
                      _selectedCars = values.cast<String>();
                    });
                  },
                  initialValue: _selectedCars,
                  decoration: BoxDecoration(
                    color:
                        kPrimaryColor, // Background color of selection button
                    border: Border.all(
                        color:
                            kPrimaryColor), // Border color of selection button
                    borderRadius: BorderRadius.circular(
                        25), // Border radius of selection button
                  ),
                  chipDisplay: MultiSelectChipDisplay(
                    chipColor: kPrimaryLightColor, // Chip color
                    textStyle: TextStyle(
                      color: Colors.black,
                      fontWeight: FontWeight.bold,
                    ), // Chip text color
                  ...
                  // Search hint text
                  listType: MultiSelectListType.CHIP, // List type
