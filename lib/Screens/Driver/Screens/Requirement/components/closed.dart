...
class _LatestState extends State<Closed> {
        ...
        child: Stack(children: [
          ...
          Positioned(
            ...
            child: Icon(
              ...
              color: closedgreen, // Icon color updated to yellow
            ),
          ),
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                ...
                                right:
                                    screenWidth * 0.025), // Adjust top padding
                            child: Text(
                              date,
                              style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold,
                                color: Colors
                                    .white, // Text color updated to yellow
                              ),
                            ),
                          ),
                        ],
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: closedgreen, // Set button color
                      ),
                      child: TextButton(
                        onPressed: () {
                          Navigator.push(
