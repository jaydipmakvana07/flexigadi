import 'package:flexigadi/Screens/Calculator/screen/calculator.dart';
import 'package:flutter/material.dart';
import 'package:curved_navigation_bar/curved_navigation_bar.dart';
import '../../../constants.dart';
import '../../Driver/Screens/Home/screens/homescreen.dart';
import '../Screens/Requirement/screen/requirementscreen.dart';
import '../../Driver/Screens/Available/screen/availablescreen.dart';
...
class _BottomMenuBarState extends State<BottomMenuBar> {
  ...
  Widget build(BuildContext context) {
    return CurvedNavigationBar(
      ...
      height: 50.0,
      items: <Widget>[
        Icon(Icons.add, size: 30, color: iconColors[0]),
        ...
        setState(() {
          ...
          switch (index) {
            ...
            case 1:
              ...
              Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (context) => RequirementdriverScreen(),
              ));
              break;
            case 2:
              // Navigate to Home
